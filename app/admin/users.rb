ActiveAdmin.register User do
  ...
  #
  permit_params :email, :encrypted_password, :reset_password_token, :reset_password_sent_at, :remember_created_at, :first_name, :last_name, :occupation, :address, :birthday, :country, :phone_number, :gender, :city, :zip_code, :title, :admin, :file, :avatar
  #
  # or
  #
  # permit_params do
